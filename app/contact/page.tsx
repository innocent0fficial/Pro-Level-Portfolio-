          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            >
              <div className="mb-12">
                ...
                <h2 className="text-3xl font-black mb-2">innocent Hacker</h2>
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">innocent.wolrd110@gmail.com</p>
                  </div>
                </motion.div>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-purple-200">+923221857442</p>
                  </div>
                </motion.div>
